...
closed-at: "2026-02-02T21:06:49.353022-06:00"
close-reason: Added full 6-color palette per layer (primary, secondary, accent, shadow, highlight, ore_tint). Layers progress from warm browns at surface through neutral grays to cool blues and alien purples at depth. Updated data_registry to use new palette-based color selection with layer transitions.
---
